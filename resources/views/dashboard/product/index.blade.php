...
<div class="d-flex justify-content-end mb-3">
    <a href="{{route('product.dashboard.product.create')}}" class="btn btn-createproduct">Add Product</a>
</div>
...
<div class="border-product mb-3">
            ...
            <div class="font-titleproduct">
                <a href="{{route('home.show', $product->title)}}" style="color: black">{{ $product->title }}</a> 
            </div>
            <div class="font-priceproduct">Rp. {{ number_format($product->price) }}</div>
            <hr class="hr-product">
            <a href="{{route('product.dashboard.product.edit', compact('product'))}}"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{route('product.dashboard.product.destroy', compact('product'))}}" method="POST">
                                @csrf
                                @method('DELETE')
